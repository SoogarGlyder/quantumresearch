    ...
    {jadwalSemua.length === 0 ? (
      ...
      <div className={styles.scheduleList}>
        {jadwalSemua.map((j) => {
          ...
          // 🚀 FIX: Komparasi menggunakan object Date agar selalu akurat lintas bulan/tahun
          const dateJadwal = new Date(j.tanggal);
          const dateHariIni = new Date(hariIni);
          dateJadwal.setHours(0, 0, 0, 0);
          dateHariIni.setHours(0, 0, 0, 0);
          
          const isMasaDepan = dateJadwal.getTime() > dateHariIni.getTime();
...
// ============================================================================
// 5. SUB-KOMPONEN: MODAL FORM JURNAL (State Colocation & Full Screen Fix)
// ============================================================================
