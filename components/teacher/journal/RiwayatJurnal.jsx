...
import PaginationBar from "@/components/ui/PaginationBar"; // 🚀 FIX: Import Pagination
import styles from "@/components/App.module.css";

const RiwayatJurnal = memo(({ dataHalIni, totalPage, onPilihJadwal }) => (
