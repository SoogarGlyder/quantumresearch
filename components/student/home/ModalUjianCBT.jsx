      ...
      <div className={styles.containerGallery} style={{ display: 'flex', flexDirection: 'column', height: '100%', padding: 0, overflow: 'hidden', position: 'relative' }}>
        ...
        {showPeringatan && !isReviewMode && (
          <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.8)', zIndex: 999999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
            <div style={{ background: '#fef2f2', padding: '30px', borderRadius: '16px', textAlign: 'center', maxWidth: '350px', border: '4px solid #111827', boxShadow: '8px 8px 0 #ef4444' }}>
              ...
              <p style={{ color: '#111827', fontWeight: 'bold', marginBottom: '20px' }}>
                Anda terdeteksi meninggalkan layar ujian. Peringatan ke-{pelanggaran}/3.
              </p>
              <button onClick={() => setShowPeringatan(false)} style={{ width: '100%', padding: '15px', background: '#ef4444', color: 'white', border: '3px solid #111827', borderRadius: '12px', fontWeight: '900', cursor: 'pointer', boxShadow: '4px 4px 0 #111827' }}>
                SAYA MENGERTI
              </button>
            </div>
          </div>
        ...
        {koneksiTerputus && !isReviewMode && (
          <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(15, 23, 42, 0.95)', zIndex: 999999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
            <div style={{ background: '#fef08a', padding: '30px', borderRadius: '16px', textAlign: 'center', maxWidth: '400px', border: '4px solid #111827', boxShadow: '8px 8px 0 #111827' }}>
              ...
              <p style={{ color: '#111827', fontSize: '15px', fontWeight: 'bold', marginBottom: '30px' }}>
                Gagal mengirim. <strong style={{ color: '#ef4444' }}>JANGAN TUTUP APLIKASI!</strong><br/><br/>
                Sistem akan mengulang otomatis saat internet stabil.
              </p>
              <button onClick={eksekusiSubmit} style={{ width: '100%', padding: '15px', background: '#3b82f6', color: 'white', border: '3px solid #111827', borderRadius: '12px', fontWeight: '900', cursor: 'pointer', display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '8px', boxShadow: '4px 4px 0 #111827' }}>
                COBA KIRIM MANUAL
              </button>
            </div>
          </div>
        ...
        <div className={styles.headerGallery} style={{ flexShrink: 0, background: isReviewMode ? '#dcfce3' : '#facc15', borderBottom: '4px solid #111827', padding: '15px 20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div className={styles.wrapperTitle}>
            <h3 className={styles.galleryTitle} style={{ color: '#111827', fontWeight: '900' }}>
              {isReviewMode ? `REVIEW CBT | ${siswa.nama}` : `QUANTUM CBT | ${siswa.nama}`}
            </h3>
            {!isReviewMode && (
          ...
          }} style={{ border: '2px solid #111827', background: 'white' }}>
        ...
        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflowY: 'auto' }}>
          ...
          <div style={{
            ...
            borderBottom: '4px solid #111827', display: 'flex', flexDirection: 'column', gap: '10px'
          }}>
            ...
            <div style={{ background: 'white', padding: '24px', borderRadius: '16px', border: '4px solid #111827', boxShadow: '8px 8px 0 #111827', marginBottom: '30px' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                {opsiAbjad.map((opsi) => {
                  ...
                  let bgOpsi = 'white';
                  let bgHuruf = '#f1f5f9';
                  let textHuruf = '#111827';
                  let bayanganOpsi = '4px 4px 0 #111827';
                  ...
                  return (
                    <div key={opsi} onClick={() => handlePilihJawaban(soalAktif, opsi)}
                      style={{ 
                        ...
                        background: bgOpsi, border: '3px solid #111827', borderRadius: '12px', boxShadow: bayanganOpsi,
                        cursor: isReviewMode ? 'default' : 'pointer', transition: '0.1s',
                        transform: (!isReviewMode && isSelected) ? 'translate(2px, 2px)' : 'none'
                      }}>
                      <span style={{ 
                        fontWeight: '900', width: '36px', height: '36px', display: 'flex', justifyContent: 'center', alignItems: 'center', 
                        flexShrink: 0, background: bgHuruf, color: textHuruf, borderRadius: '8px', border: '2px solid #111827', fontSize: '16px' 
                      }}>
              ...
              {isReviewMode && soalSekarang.pembahasan && (
                <div style={{ marginTop: '30px', padding: '20px', background: '#fef08a', border: '3px solid #111827', borderRadius: '12px', boxShadow: '4px 4px 0 #111827' }}>
                  <span style={{ display: 'block', fontWeight: '900', color: '#111827', marginBottom: '12px', fontSize: '15px', background: 'white', display: 'inline-block', padding: '4px 10px', borderRadius: '6px', border: '2px solid #111827' }}>💡 PEMBAHASAN:</span>
            ...
            <div style={{ display: 'flex', gap: '12px', marginTop: 'auto', paddingBottom: '20px' }}>
              ...
              {!isReviewMode && isSoalTerakhir ? (
                ...
                <button onClick={() => {
                  ...
                  {(isReviewMode && isSoalTerakhir) ? "TUTUP" : "LANJUT"} <FaChevronRight />
                </button>
              )}
            </div>
...
//         {showPeringatan && !isReviewMode && (
//           <div style={{ position: 'absolute', top: 0, left: 0, right: 0, bottom: 0, background: 'rgba(0,0,0,0.8)', zIndex: 999999, display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
//             <div style={{ background: 'white', padding: '30px', borderRadius: '15px', textAlign: 'center', maxWidth: '350px', border: '4px solid #ef4444' }}>
//               <FaTriangleExclamation size={50} color="#ef4444" style={{ marginBottom: '15px' }} />
...
//           }}>
//             <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
//               <h4 style={{ margin: 0, fontWeight: '900', color: '#475569', fontSize: '13px' }}>PALET SOAL</h4>
//             </div>

//             <div style={{ display: 'flex', gap: '8px', overflowX: 'auto', paddingBottom: '5px', WebkitOverflowScrolling: 'touch', userSelect: 'none' }}>
//               {daftarSoal.map((soal, index) => {
//                 const isTerjawab = !!jawabanSiswa[index];
//                 const isAktif = soalAktif === index;
...
//                   {isSubmitting ? "MENGIRIM..." : <><FaCheckDouble /> SELESAIKAN</>}
//                 </button>
//               ) : (
//                 <button onClick={() => {
//                   if (isReviewMode && isSoalTerakhir) onClose();
